...
import 'package:flutterHub/animated_responsive_layout/widgets/star_button.dart';
...
class _EmailWidgetState extends State<EmailWidget> {
  ...
  late Color unSelectedColor = Color.alphaBlend(
      _colorScheme.primary.withOpacity(0.88),
        ...
        child: Column(
          ...
          children: [
            if (widget.showHeadline) ...[
              EmailHeadLine(email: widget.email,
                  isSelected: widget.isSelected),
            ],
            EmailContent(email: widget.email,
...
class EmailContent extends StatefulWidget {
  const EmailContent({super.key, required this.email, required this.isPreview, required this.isThreaded, required this.isSelected});
              ...
              return Row(
                children: [
                  if (constraints.maxWidth - 200 > 0)...[
                    CircleAvatar(backgroundImage: AssetImage(widget.email.sender.avatarUrl)
                    ),
                  ...
                  Column(
                    ...
                    children: [
                      Text(widget.email.sender.name.fullName,
                          ...
                          maxLines: 1,
                          style: widget.isSelected ?  _textTheme.labelMedium?.copyWith(color: _colorScheme.onSecondaryContainer) :
          ...
          Column(
            ...
            children: [
              ...
              if (widget.isThreaded)...[
                contentSpacer,
                Text(
                  "To ${widget.email.recipients.map((e) => e.name.first).join(", ")}",
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('${widget.email.replies.toString()} message',
                        maxLines: 1,
                        overflow: TextOverflow.fade,
